...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Configuración relacionada con normativaç
\usepackage{float}
\usepackage{amsfonts}
\usepackage{graphicx}
...
\usepackage[backend=biber,style=alphabetic]{biblatex} % bibliografía
...
\input{secciones/Espacios Recubridores}

\input{secciones/Clasificación de Espacios Recubridores}

\input{secciones/Aplicaciones a la Teoria de Grupos}

\input{secciones/Conclusión}
